		...
		<div class="row">
			...
			<main class="site-main" id="main">
				...
				<header class="page-header author-header">
					...
					<h1><?php esc_html_e( 'About:', 'wbase' ); ?><?php echo esc_html( $curauth->nickname ); ?></h1>
					...
					<dl>
						<?php if ( ! empty( $curauth->user_url ) ) : ?>
							<dt><?php esc_html_e( 'Website', 'wbase' ); ?></dt>
							<dd>
						...
						<?php if ( ! empty( $curauth->user_description ) ) : ?>
							<dt><?php esc_html_e( 'Profile', 'wbase' ); ?></dt>
							<dd><?php echo esc_html( $curauth->user_description ); ?></dd>
						<?php endif; ?>
					</dl>

					<h2><?php esc_html_e( 'Posts by', 'wbase' ); ?> <?php echo esc_html( $curauth->nickname ); ?>
						:</h2>
						...
						<?php while ( have_posts() ) : the_post(); ?>
							<li>
								<a rel="bookmark" href="<?php the_permalink() ?>" title="Permanent Link: <?php the_title(); ?>">
									<?php the_title(); ?></a>,
								<?php wbase_posted_on(); ?> <?php esc_html_e( 'in', 'wbase' ); ?> <?php the_category( '&' ); ?>
							</li>
						<?php endwhile; ?>
